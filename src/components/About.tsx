...
export function About() {
  return (
    <section id="about" className="theme-section py-24 px-20 bg-white transition-colors duration-300">
      <div className="max-w-[1280px] mx-auto">
        <h2 className="theme-title text-4xl font-bold text-center mb-4 text-[#111827] font-['Poppins']">About Me</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              <div className="text-center">
                ...
                <h3 className="theme-title text-2xl font-bold text-[#111827] mb-1">3+</h3>
                <p className="theme-copy text-sm text-[#64748B]">Years Experience</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="theme-title text-2xl font-bold text-[#111827] mb-1">5+</h3>
                <p className="theme-copy text-sm text-[#64748B]">Projects</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="theme-title text-2xl font-bold text-[#111827] mb-1">12+</h3>
                <p className="theme-copy text-sm text-[#64748B]">Technologies</p>
              </div>
            </div>
          </div>
        </div>
